               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>Child Care Centre <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					<img src="img/services/1.png" class="main_picture" />
					<h4>Building Summary</h4>
					<p>
						This will be a new construction project consisting of a one storey building to be a Child Care Centre for the Children and Women’s Health Centre of Vancouver, BC. With a building area of 7,400 ft2.
						The Child Care Centre provides a number of day care program uses for up to 49 children including infant, toddler and preschooler program areas within the facility. Main facilities include staff office, bike, cubby, parent observation, kitchen, storage, laundry, WC, and nap rooms.
					</p><br>
					...
					<p>
						...
						<ul>
							...
							<li>Building Domestic Cold Water,  Irrigation Water, Domestic Hot Water Consumption</li>
							...
							<li>Air Change and Distribution</li>
						</ul>
						</p><br>
