        ...
        <div class="container">
			...
			<!-- Example row of columns -->
				...
				<div class="row animated fadeInLeft">
						...
						<div class="span25">
						<img src="img/people/sloba.png"><img src="img/people/eco-opera-people.png" style="float: right;"><br>
						<strong>:: SLOBODAN VUKADINOV</strong>
						<br>
						<div style="border-top: 1px solid grey; border-bottom: 1px solid grey;margin-top: 10px;"><strong>VICE PRESIDENT :: EMIS ARCHITECT</strong></div>
