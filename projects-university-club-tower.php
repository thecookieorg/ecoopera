               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>1021 W. Hastings, University Club tower <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					<img src="img/services/1.png" class="main_picture" />
					<h4>Building Summary</h4>
					<p>
						This will be a new construction in downtown Vancouver, BC consisting of a 35 storey office building with four levels of parking below grade. Approximate total office and level retails FSR would be 303,000 ft2 on gross site area of 50,436 ft2. 
						The new tower will be used primarily as office space for multiple tenants, with areas on the first three floors for retail services.
					</p><br>
					...
					<ul>
							...
							<li>Floor by Floor Lighting/Plugs and Mechanical Energy</li>
							<li>VRF System Efficiency and Heat Recovery</li>
							<li>Recovered Energy from Cooling tower</li>
							<li>Office and Parking Lighting Energy</li>
							<li>Emergency Lighting, Plugs, and Elevator Energy</li>
							...
							<li>Air Change and Distribution At Floors</li>
						</ul>
					</p><br>
