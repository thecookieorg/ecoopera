               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>Telus Garden Office Tower C&amp;S <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					<img src="img/services/1.png" class="main_picture" />
					<h4>Building Summary</h4>
					<p>
						This project involves the construction of a new 22 level commercial office tower with three main zones: South, North and BAR including retail space on the ground floor with a total FSR area of 459,537 ft2 on a 40,825 ft2 site.  The site is located at West Georgia St. in Vancouver, BC.
					</p><br>
					...
					<p>
						The M&amp;V plan has been formulated in consistency with Option D (Whole Building Simulation) of the 2006 International Performance Measurement & Verification Protocol (IPMVP) Volume III. Some of the sustainable features and energy efficiency measures (EEMs) included in the building to note are:  heat source from nearby Telus building, high efficiency VRF controlled chillers, 100% outdoor air via heat recovery ventilators, solar PV and hot water collectors, free cooling via central cooling tower, rainwater harvesting for toilets and irrigation, CO2 demand controlled ventilation, building-wide BAS, low-flow water fixtures, raised floor displacement air ventilation system, CES M&V integration with all electrical, mechanical and control systems with instantaneous realtime data, and etc. The M&V system monitors the following building systems and sub-systems among other measurement points:
					<ul>
							<li>Total Space Heating Energy</li>
							<li>Total Space Mechanical Cooling Energy</li>
							<li>Pump and Fan Energy</li>
							<li>Renewable (Photovoltaic) Electrical Energy</li>
							<li>Recovered Energy from Cooling tower, Chiller units, and HPs units</li>
							<li>Cooling Energy to Office Tower Radiant and AHU Systems</li>
							<li>Office and Parking Lighting Energy</li>
							<li>Emergency Lighting and Plugs Energy</li>
							<li>Cold Water Make-up to Cooling Tower, Office Tower and DHWT</li>
							<li>Mechanical Equipment Electrical Energy </li>
