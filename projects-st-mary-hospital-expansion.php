               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>St. Mary’s Hospital Expansion <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					<img src="img/projects/st-mary-expansion.png" class="main_picture">
					<p>
						St Mary’s hospital expansion project includes a new addition to accommodate the expanding Emergency and Diagnostic Imaging departments and new inpatient beds, including labour and delivery rooms and an intensive care unit, above the Emergency and Diagnostic Imaging departments.<br/>
						<br/>
						CES Engineering Ltd acting as a Commissioning Authority for this LEED Gold targeted project is tasked to manage, administrate and execute the complete measuring and verification process. This project is currently in the construction stage. <br/>
						<br/>
						...
						<ul>
							...
							<li>Fluid Cooler Loop Energy</li>
							...
							<li>Building Gas consumption</li>
							<li>Domestic water consumption</li>
							<li>Domestic hot water energy</li>
							<li>Total electrical power consumption</li>
							<li>Separate consumption for lighting, mechanical and plug loads at the various power distribution centers and panels</li>
