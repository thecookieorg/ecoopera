        ...
        <div class="container">
            ...
            <div class="row animated fadeInLeft">
				...
				<div class="span8 margin_main_container">
					...
					<h4>Operations Managers – Utility Cost Control</h4>
					<p>
					...
					<h4>Utility Conservation Program Managers – Return-on-Investment</h4>
					<p>
					...
					<h4>Energy Managers – Energy and Emissions Tracking</h4>
					<p>
					...
					<h4>Building Operators – Equipment and Systems Performance Issues</h4>
					<p>
					...
					<h4>Engineering Consultants – Optimization Opportunities and Design</h4>
					<p>
					...
					<p>
						...
						<ul>
							<li>Real-time energy and operational monitoring and alerting;</li>
							<li>Benchmarking against standards, historical performance or simulated conditions;</li>
							<li>Breakdowns of utility consumption, costs and energy end-uses;</li>
							<li>Statistical modelling for flexible benchmark creation;</li>
							<li>Sortable inventories of buildings, utility services, meters, systems, plants, and equipment;</li>
							<li>Graphical data presentations including trend-logs, control charts, scatter-plots, cumulative sums, histograms and bin data;</li>
							<li>Whole building analytics including energy, cost, and emission intensities, and energy profiles;</li>
							<li>Whole building analytics including energy, cost, and emission intensities, and energy profiles;</li>
							<li>Systems analytics including efficiencies, run-times and operating condition summaries;</li>
							<li>Performance forecasting and what-if analysis;</li>
							<li>Custom reporting, modelling and module programming;</li>
							<li>Integration with external data sources include energy models and weather stations;</li>
						</ul>
					</p>
