               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>Prince George RCMP <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					...
					<ul>
							...
							<li>Solar Hot Water Heat Gain Energy</li>
							<li>Geo-exchange Heat Recovery Energy</li>
							<li>Lighting and Plug Loads Energy</li>
							<li>UPS, Life Safety and Emergency power Energy</li>
							<li>Domestic Water Consumption</li>
							<li>Gained Energy via District System</li>
							<li>Chiller and Dedicated Air Conditioning energy</li>
							<li>Outdoor Air Volumes</li>
							<li>Energy Recovery and Gained from Five HXs</li>
