               ...
               <?php include('includes/sidebar_nav_projects.php'); ?>
				<div class="span8 margin_main_container">
					<div class="title_bkgd">
						<h3>AFK Gallery <!--<img src="img/services/green-line.png" class="green_line" />--></h3>
					</div>
					<img src="img/services/1.png" class="main_picture" />
					<h4>Building Summary</h4>
					<p>
						This project entails the construction of the new Artist for Kids Gallery and Education Services Centre for the North Vancouver School Board. The new facility constitutes five stories in height with a total floor area of 62,000 Ft2.
					</p><br>
					...
					<p>
						The M&V plan has been formulated in consistency with Option D (Whole Building Simulation) of the 2003 International Performance Measurement & Verification Protocol (IPMVP) Volume III. Some of the sustainable features and energy efficiency measures (EEMs) included in the building to note are:  high efficient central heating and cooling district system, pre-heating of O/A through WWHPs, variable flow displacement ventilation, low temp. radiant slabs, low-flow water fixtures, daylight harvesting, CO2 demand controlled ventilation, CES M&V integration with all electrical, mechanical and control systems with instantaneous realtime data, Occ. Sensors, high efficient lighting and etc. The M&V system monitors the following building systems and sub-systems among other measurement points:
						<ul>
							<li>Total Space Heating</li>
							<li>Total Space Cooling</li>
							<li>Pump and Fans Energy</li>
							<li>Humidifier Energy</li>
							<li>Lighting, Plug Loads, UPS and Elevator Energy</li>
							<li>Domestic Water Consumption</li>
							<li>Gained Energy via District System</li>
							<li>Recovered Energy via Heat Recovery Systems</li>
							<li>Outdoor Air Volumes</li>
							<li>Energy Recovery and Gained from four HXs</li>
